...
In this paper, we will study how Combinatorial Testing (CT) fits in with the front-end test automation and the continuous deployment of cloud computing paradigm.
...
\subsection{Description of the Test Code Structure}
	...
	Over time during our development, the test specification came to be described in State-based, Behavior-driven Acceptance Scenarios \cite{stateobjects}. 
...
\end{figure*}
  ...
  Through parameterization this complexity is abstracted. The test code only uses the parameters and the values of the parameters are easily manipulated depending on UI changes and or test configurations.
	...
	To conclude this sections, Figure~\ref{fig:sortingTestCode} displays automated Protractor test code for one of the 19 tests.
