...
\section{The System Under Test}
	...
	This automated testing process ensures that after any code commit, the application is tested quality is ensured. 
...
While testing interactions of at most six input parameters are needed to find all faults in a given functionality of a software product, \emph{2-way} testing still ensures cost-effective coverage of most possible faults \cite{NISTpractical}.
...
CT assured that the test design process lead to writing meaningful and cost-effective automated tests that are more likely to find defects, bolstering confidence in the quality of the SUT.
...
Using latest features in ECMAscript, the overall test design was interpreted to sequential looking asynchronous test code that executes as fast as the environment allows, resistant to flakey tests and stale elements.
